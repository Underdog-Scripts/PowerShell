...
Get-WmiObject -Class Win32_DiskDrive -ErrorAction SilentlyContinue -ComputerName $DeviceName | Select Caption, Size | Out-GridView -Title "$DeviceName Drive Size"