...
Get-WmiObject -Class Win32_ComputerSystem -ErrorAction SilentlyContinue -ComputerName $Device | Select Name, Caption, ChassisSKUNumber, Manufacturer, Model, OEMStringArray, PrimaryOwnerName, TotalPhysicalMemory | Out-GridView -Title "$DeviceName Chassis and Memory"