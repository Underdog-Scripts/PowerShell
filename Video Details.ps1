...
Get-WmiObject -Class Win32_VideoController -ErrorAction SilentlyContinue -ComputerName $DeviceName | Select PSComputerName, VideoModeDescription, Caption, Description, Name, VideoProcessor | Out-GridView -Title "$DeviceName Video Details"