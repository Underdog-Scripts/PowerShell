<#	
	...
	===========================================================================
	.DESCRIPTION
		Display last bootup time for a computer
#>
...
Get-WmiObject Win32_OperatingSystem -ComputerName $DeviceName | Select Csname, BuildNumber, @{Label="LastBootUpTime";Expression={$_.ConverttoDateTime($_.lastbootuptime)}} | Out-GridView -Title "$DeviceName last bootup time"