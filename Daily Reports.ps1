...
Last Modified:   9.15.2021, 11.10.2021, 2.8.22, 2.21.2022
Created by:      Gary Brunner
Organization:    Gary Brunner
Filename:        Daily Reports.ps1 
===========================================================================
.DESCRIPTION
Provides daily SCCM OS and Deployment reports
#>

# Log file location and name
$ScriptName = "Daily Reports"
...
If (Test-Path ".\Deployments $TodayIs.csv") {
    ...
    Write-Output "Copy-Item .\Deployments $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\Deployments $TodayIs.csv"
} Else {
...
If (Test-Path ".\OS Report $TodayIs.csv") {
    ...
    Write-Output "Copy-Item .\OS Report $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\OS Report $TodayIs.csv"
} Else {
...
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\Deployments $TodayIs.csv") {
    ...
    Write-Output "Remove-Item .\Deployments $TodayIs.csv"
}
...
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\OS Report $TodayIs.csv") {
    ...
    Write-Output "Remove-Item .\OS Report $TodayIs.csv"
}
