...
Modified on:     11/27/2021 7:32 PM, 2.8.22 3:32 PM, 2.22.22
Created by:      Gary Brunner
Filename:        Weekly Reports Timed.ps1 
===========================================================================
.DESCRIPTION
...
$ScriptName = "Weekly Reports Timed"
...
If (Test-Path ".\Deployments $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\Deployments $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\Deployments $TodayIs.csv"
} Else {

    Write-Host "Deployments $TodayIs.csv not found"
}
...
If (Test-Path ".\OS Report $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\OS Report $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\OS Report $TodayIs.csv"
} Else {

    Write-Host "OS Report $TodayIs.csv not found"
}
...
If (Test-Path ".\Hardware Report Full List of Hardware $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\Hardware Report Full List of Hardware $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\Hardware Report Full List of Hardware $TodayIs.csv"
} Else {

    Write-Host "Hardware Report Full List of Hardware $TodayIs.csv not found"
}
...
If (Test-Path ".\CR026 Computers Not Actively Reporting $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR026 Computers Not Actively Reporting $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR026 Computers Not Actively Reporting $TodayIs.csv"
} Else {

    Write-Host "CR026 Computers Not Actively Reporting $TodayIs.csv not found"
}
...
If (Test-Path ".\CR063 Patch Levels $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR063 Patch Levels $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR063 Patch Levels $TodayIs.csv"
} Else {

    Write-Host "CR063 Patch Levels $TodayIs.csv not found"
}
...
If (Test-Path ".\CR064 Computers Missing Patches $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR064 Computers Missing Patches $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR064 Computers Missing Patches $TodayIs.csv"
} Else {

    Write-Host "CR064 Computers Missing Patches $TodayIs.csv not found"
}
...
If (Test-Path ".\CR066 Admin User Accounts $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR066 Admin User Accounts $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR066 Admin User Accounts $TodayIs.csv"
} Else {

    Write-Host "CR066 Admin User Accounts $TodayIs.csv not found"
}
...
If (Test-Path ".\CR067 Computer Utilization (CR026) $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR067 Computer Utilization (CR026) $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR067 Computer Utilization (CR026) $TodayIs.csv"
} Else {

    Write-Host "CR067 Computer Utilization (CR026) $TodayIs.csv not found"
}
...
If (Test-Path ".\CR068 Disk Space Usage $TodayIs.csv") {
    ...
    Write-Host "Copy-Item .\CR068 Disk Space Usage $TodayIs.csv -Destination \\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR068 Disk Space Usage $TodayIs.csv"
} Else {

    Write-Host "CR068 Disk Space Usage $TodayIs.csv not found"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\OS Report $TodayIs.csv") {
	Remove-Item ".\OS Report $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\Hardware Report Full List of Hardware $TodayIs.csv") {
	Remove-Item ".\Hardware Report Full List of Hardware $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR026 Computers Not Actively Reporting $TodayIs.csv") {
	Remove-Item ".\CR026 Computers Not Actively Reporting $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR063 Patch Levels $TodayIs.csv") {
	Remove-Item ".\CR063 Patch Levels $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR064 Computers Missing Patches $TodayIs.csv") {
	Remove-Item ".\CR064 Computers Missing Patches $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR066 Admin User Accounts $TodayIs.csv") {
	Remove-Item ".\CR066 Admin User Accounts $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR067 Computer Utilization (CR026) $TodayIs.csv") {
	Remove-Item ".\CR067 Computer Utilization (CR026) $TodayIs.csv"
}

Start-Sleep -Seconds 2
If (Test-Path "FileSystem::\\IL7354-964\C$\Users\2brunnga\Documents\Reports\New\CR068 Disk Space Usage $TodayIs.csv") {
	Remove-Item ".\CR068 Disk Space Usage $TodayIs.csv"
}
