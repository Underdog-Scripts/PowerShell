...
===========================================================================
.DESCRIPTION
Provides listing for application installs on a system
#>
...
Function Create-Form {
    ...
    $Form.Text = "Find application installs"
    $Form.Size = New-Object System.Drawing.Size(380, 166) 
    ...
    $ComputerIDTextBox.Size = New-Object System.Drawing.Size(200, 28)
    ...
    $CheckBox.location = New-Object System.Drawing.Point(102,82)
...
Function GetID([String]$ReportName) {
    ...
    If ($CheckBox.Checked) {
        ...
        Order by SYS.Netbios_Name0,
        ISW.ProductName0,
        ISW.ProductVersion0" | Out-GridView -Title "Applications on $ReportName"
