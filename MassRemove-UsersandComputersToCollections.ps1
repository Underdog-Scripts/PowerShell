...
$UserAndComputers = Import-CSV -LiteralPath "\\pmusa.net\dslpmu\Projects\Windows10\Scripts\Tools\SCCM_Scripts\BulkCollectionUpdates\Remove_Users-Computers.csv"

$option = [System.StringSplitOptions]::RemoveEmptyEntries

#Logfile information
$logfile = ("\\pmusa.net\dslpmu\Projects\Windows10\Scripts\Tools\SCCM_Scripts\BulkCollectionUpdates\Logs\SCCM-User&ComputerCollectionRemoves.log") 
