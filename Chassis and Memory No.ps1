...
Get-WmiObject -Class  Win32_SystemEnclosure -ErrorAction SilentlyContinue -ComputerName $DeviceName | Select PSComputerName, ChassisTypes | Out-GridView -Title "$DeviceName Chassis and Memory"
