...
$UserAndComputers = Import-CSV -LiteralPath "C:\Users\brunnegt\Documents\Scripts\PowerShell\Add-Computers.csv"

$option = [System.StringSplitOptions]::RemoveEmptyEntries

#Logfile information
$logfile = ("C:\Users\brunnegt\Documents\Scripts\PowerShell\Add-Computers.log") 
